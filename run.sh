...
commands=(
    ...
    "ectf_update --infile build/ap.img --port /dev/tty.usbmodem141102"
    "ectf_update --infile build/comp1.img --port /dev/tty.usbmodem141202"
    "ectf_update --infile build/comp2.img --port /dev/tty.usbmodem141302"
